...
import { validateId, validateMissingFields } from "../middlewares/validator.js";

const router = express.Router();

/* === READ ============================================= */
router.get("/one/:id", validateId, async (req, res) => {
  try {
...
/* === CREATE =========================================== */
router.post("/create", validateMissingFields, async (req, res) => {
  try {
